            ...
            <View className={"sub-bdy"}>
                ...
                <View className={"sub-row"}>
                    <View className={"sub-row-copy"}>
                        ...
                        <Text className={"sub-value"} numberOfLines={1} ellipsizeMode={"tail"}> {startDate ? formatSubscriptionDateTime(startDate): ''
                        }
                        </Text>
                    </View>
                </View>
                ...
                <View className={"sub-row"}>
                    <View className={"sub-row-copy"}>
                        ...
                        <Text className={"sub-value"} numberOfLines={1} ellipsizeMode={"tail"}> {renewalDate ? formatSubscriptionDateTime(renewalDate):
                        ''} </Text>
                    </View>
                </View>
